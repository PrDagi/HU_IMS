...
class User:
    ...
    def user_mainmenu(self,a,b):
        ...
        self.mainframe.place(x=330, y=75)
    ...
    def user_input(self):
       ...
       Button(self.entryframe,text="Proceed",command=self.transtableadd,bd=6,width=8,height=4,bg="#FFFFFF",font="roboto 10").place(x=0,y=30)
       Button(self.entryframe, text="Add to cart", command=self.addtotrans, bd=6, width=10, height=2,bg="#FFFFFF",font="roboto 10").place(x=120,y=70)
       Button(self.entryframe, text="Remove", command=self.removecart, bd=6, width=10, height=2, bg="#FFFFFF",font="roboto 10").place(x=230, y=70)
       ...
       carttotal.place(x=130, y=150, height=30)
       ...
       Label(self.entryframe, text="Amount Due", font="roboto 14 bold", bg="#ffffff").place(x=0, y=150)
       ...
       Entry(self.entryframe1, textvariable=self.cartitemid, font="roboto 14", bg="#FFFFFF", width=25, state='readonly').place(x=162, y=0,height = 30)
       Entry(self.entryframe1, textvariable=self.cartitem, font="roboto 14", bg="#FFFFFF", width=25, state='readonly').place(x=162, y=50,height=30)
       Entry(self.entryframe1, textvariable=self.cartitemprice, font="roboto 14", bg="#FFFFFF", width=25, state='readonly').place(x=162,y=50*2,height=30)
       Entry(self.entryframe1, textvariable=self.cartitemstock, font="roboto 14", bg="#FFFFFF", width=25, state='readonly').place(x=162,y=50*3,height=30)
       self.id_qty=dict()
